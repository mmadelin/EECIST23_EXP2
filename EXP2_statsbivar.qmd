...
# Analyse d'une relation {background-image="img/template_diapo_EECIST_partie.png" background-size="cover"}
...
[Erreur écologique / erreur atomiste]{style="color:#c4327e"}
...
-   éventuellement [modéliser]{style="color:#20639B"} la relation et analyse des [écarts au modèle]{style="color:#20639B"} ou donner un [sens]{style="color:#20639B"} à la relation
...
![](https://imgs.xkcd.com/comics/extrapolating.png){width=75% fig-align="center"}
...
::: {.callout-note appearance="minimal" icon="FALSE" .fragment}
Pour Lagos,

H~0~ : indépendance entre températures de surface et types morphologiques

H~1~ : il existe une relation entre températures de surface et types morphologiques
:::
...
![](img/Var_totale.png){fig-align="center" .fragment width="80%"}


![](img/Var_interclasse.png){fig-align="center" .fragment width="80%"}

![](img/Var_intraclasse.png){fig-align="center" .fragment width="80%"}
